...
$DIR/../target/$TARGET/dtnd -d -j5s -w $PORT_NODE1 -e incoming -r epidemic -n node1 --interval 1s --ecla --disable_nd $DB1 $STATUS_REPORTS 2>&1 &> $OUT_NODE1 &
PID_NODE1=$!
...
$DIR/../target/$TARGET/examples/dtnecla_connect_n -a 127.0.0.1:$PORT_NODE1 -a 127.0.0.1:$PORT_NODE2 -a 127.0.0.1:$PORT_NODE3 & PID_ECLA=$!
