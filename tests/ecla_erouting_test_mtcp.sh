...
$DIR/../target/$TARGET/dtnd -d -j5s -i0 -w $PORT_NODE2 -C mtcp:port=4223 -e incoming -r external \
    -n node2 \
...
$DIR/../target/$TARGET/dtnd -d -j5s -i0 -w $PORT_NODE3 -e incoming -r epidemic -n node3 -s mtcp://127.0.0.1:4223/node2 --ecla $DB3 $STATUS_REPORTS 2>&1 &> $OUT_NODE3 &
PID_NODE3=$!
...
$DIR/../target/$TARGET/examples/dtnecla_mtcp -a 127.0.0.1:$PORT_NODE3 -p 2432 & PID_ECLA_1=$!
echo ecla pid: $PID_ECLA_1
